...
private:
    ...
    std::array<std::array<int, MAX_TARGET_LEN + 1>, MAX_QUERY_LEN + 1> m_direction_matrix;
public:
...
public:
    ...
    inline int get_direction(int row, int col) const {
    ...
    inline void set_direction(int row, int col, int direction) {
